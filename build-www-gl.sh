...
DITA_OT_INSTALL_DIR=/c/Users/grelarse/git/temp.hpcloud.doc/tools/DITA-OT
echo 1

# The path of the Saxon 9.1.0.8 install directory  
SAXON_9_DIR=/c/Users/grelarse/git/temp.hpcloud.doc/tools/saxonb9-1-0-8j
...
# DITA_MAP_BASE_DIR=$DOC_HOME
  DITA_MAP_BASE_DIR=/c/Users/grelarse/git/temp.hpcloud.doc

echo 3

# The name of the input DITA map file
  DITAMAP_FILE=docs.hpcloud.com.ditamap
#  DITAMAP_FILE=/c/Users/grelarse/git/temp.hpcloud.doc/docs.hpcloud.com.ditamap
...
DITAVAL_DIR="/c/Program Files (x86)/Oxygen XML Editor 16/samples/dita"
